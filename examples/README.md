...
Concrete, copy-paste-ready examples for common `skpm` workflows.
...
examples/
  ...
  config/
    config.yaml                 # Annotated skpm config with all registry types
  ci/
...
```bash
skpm validate ./my-new-skill
skpm package ./my-new-skill --output-dir ./dist
